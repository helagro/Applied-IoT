# Project report - IoT tutorial template
...
3. - [ ] Checkboxes needs to be fulfilled! (* means advanced level)
...
If you want you are able to publish your project directly to Github. In that case write your tutorial in the `README.md` file. If you have no prior experience with Github this might be a good time to try it out. Easiest is to use the Github Desktop application, or you can also do everything from the web browser (editing and uploading etc.).
...
- [Good examples from course 2020](https://hackmd.io/@lnu-iot/good-examples)
